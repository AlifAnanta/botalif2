...
const starts = async (Ramdani = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('Alif', {
		font: 'Standard',
	...
	Ramdani.on('connecting', () => {
		console.log(color('[ Alif Ananta ]', 'yellow'), color('PROSES NYAMBUNG...'));
	})
const spinner = { 
  "interval": 120,
  "frames": [

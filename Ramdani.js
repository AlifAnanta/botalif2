...
const Mfake = fs.readFileSync ('./media/Ramdani1.jpg')
const Mthumb = fs.readFileSync('./media/Ramdani1.jpg')
...
let fakeimage = fs.readFileSync("./media/Ramdani1.jpg")
let errorImg = 'https://i.ibb.co/FBm52Pt/1e0fe6a08b67.jpg'
let setting = JSON.parse(fs.readFileSync('./setting.json'))
//ೋ❀❀ೋ═══[SUBSCRIBE Alif Ananta]═══ೋ❀❀ೋ//
owner = setting.owner
gamewaktu = setting.gamewaktu
petik = '```'
fake = '© ᴄʀᴇᴀᴛᴏʀ ʙʏ Alif Ananta'
...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ᴄʀᴇᴀᴛᴏʀ ʙʏ ʀᴀᴍᴅᴀɴɪ ᴏғғɪᴄɪᴀʟ⸙","listType": "SINGLE_SELECT","sections": list}}, {})
        ...
        const mentions = (teks, memberr, id) => {
           (id == null || id == undefined || id == false) ? Ramdani.sendMessage(from, {text: teks.trim(), jpegThumbnail: fs.readFileSync('./media/Ramdani1.jpg')}, extendedText, { sendEphemeral: true, contextInfo: { "mentionedJid": memberr } }) : Ramdani.sendMessage(from, {text: teks.trim(), jpegThumbnail: fs.readFileSync('./media/Ramdani1.jpg')}, extendedText, { sendEphemeral: true, quoted: mek, contextInfo: { "mentionedJid": memberr } })
        }
        const sendText = (from, text) => {
           Ramdani.sendMessage(from, text, MessageType.text)
        }
        const textImg = (teks) => {
           return Ramdani.sendMessage(from, teks, text, {quoted: mek, thumbnail: fs.readFileSync('./media/Ramdani1.jpg')})
        }
        const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${senderr.split('@')[0]}:${senderr.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./media/Ramdani1.jpg')
        }}}
       const math = (teks) => {
      ...
      const hideTag = async function(from, text){
	       ...
	       Ramdani.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('media/Ramdani1.jpg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}  
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftext = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `*Hai ${pushname}👋*\n  ${moment().utcOffset('+0700').format('HH:mm:ss')} ${moment.tz('Asia/Jakarta').format('DD/MM/YYYY')}`,"title": `Hmm`,'jpegThumbnail': fs.readFileSync('./media/Ramdani1.jpg')}}}
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/Ramdani1.jpg`)},"title": `© ᴄʀᴇᴀᴛᴏʀ ʙʏ Alif Ananta⸙`,"description": "Alif Ananta", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Alif Ananta","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
📳 Mode : public mode
☢ Prefix : > multi prefix <
🔋 baterai bot : 100% seperti cintaku padamu
👨💻 Name Creator : Alif Ananta
...
`
               ...
               imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/Ramdani1.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Ramdani1.jpg`)})).imageMessage

               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'ᴊɪᴋᴀ ᴛᴏᴍʙᴏʟ ᴅɪ ʙᴀᴡᴀʜ ᴇʀʀᴏʀ sɪʟᴀʜᴋᴀɴ ᴋᴇʟɪᴋ .ᴀʟʟᴍᴇɴᴜ ᴜɴᴛᴜᴋ ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ\n© ᴄʀᴇᴀᴛᴏʀ ʙʏ Alif Ananta⸙', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
└⬣`
               ...
               buttonsMessage = {
               contentText: `${allmenu}`,
               footerText: 'ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴅᴏɴᴀsɪ ʏᴀ ᴛᴏᴛ, ᴄᴀᴘᴇ ᴄᴏᴅɪɴɢ ᴛᴇʀᴜs:ᴠ\nᴅᴀɴ ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴊᴏɪɴ ɢʀᴜᴘ ɢᴡ ʏᴀ ᴛᴏᴛ\nɢʀᴜᴘ ᴏғғɪᴄɪᴀʟ ʏᴛ Alif : https://chat.whatsapp.com/HbEeO3RlUosIYNX91xFhY2 © ᴄʀᴇᴀᴛᴏʀ ʙʏ Alif Ananta⸙', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
🎉🎊🥳🎊🎉🥳🎊🎉🥳🎊🎉🥳`
               ...
               imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/Ramdani4.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Ramdani1.jpg`)})).imageMessage

               buttonsMessage = {
               contentText: `${man}`,
               footerText: '© Creator by Alif Ananta', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
//------------------< Premium >-------------------
       ...
       case 'buypremium2':
       case 'sewabot2':
              gopeynya = 'https://i.ibb.co/kynNYTh/Ramdani1.jpg'
              teksnya = `*[ PRICE LIST ]*
*Sewa Bot © ᴄʀᴇᴀᴛᴏʀ ʙʏ Alif Ananta⸙*
*1 Hari :* 2K
*1 Minggu :* 10K
*1 Bulan :* 20K
...
case 'tiktok':
              ...
              imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/Ramdani1.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Ramdani1.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt Alif Ananta\n Helpme tu 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI Alif Ananta\`\`\`')
...
"groupName": `Alif Ananta ~ 404 ${vipi}`,
...
"caption": "https://chat.whatsapp.com/HbEeO3RlUosIYNX91xFhY2",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
"sellerJid": "6285890617231@s.whatsapp.net",
...
Ramdani.sendMessage(_.jid, 
			...
			"footerText": '© ᴄʀᴇᴀᴛᴏʀ ʙʏ ʀᴀᴍᴅᴀɴɪ ᴏғғɪᴄɪᴀʟ⸙',
			"buttons": [
...
//------------------< Lainnya >-------------------
        ...
        case 'infobot':  // Jangan Di Ubah Plise
               gopeynya = 'https://i.ibb.co/kynNYTh/Ramdani1.jpg'
               thankslort = `━━━━━ *INFO BOT* ━━━━━\n➤ *BOT INI MENGGUNAKAN SCRIPT BOT DARI YT Alif Ananta, JIKA INGIN MENDAPATKAN SC INI, TEKAN LINK DI BAWAH INI!!!*\n➤ *LINK YT Alif Ananta : https://www.youtube.com/channel/UCt8L2Ar8t4UmETR-rjWIE2A*\n➤ *RUN BOT : TERMUX*\n➤ *TIPE : NODE JS*\n➤ *BASE : Alif Ananta*\n*━━━━━━━━━━━━━━━━━━━━*`
...
tutup dulu bang stock habis

 
➖➖➖➖➖➖➖➖➖➖➖
 *_© Creator By Alif Ananta*    
➖➖➖➖➖➖➖➖➖➖➖`
               ...
               buttonsMessage = {
               contentText: `${emel}`,
               footerText: '© ᴄʀᴇᴀᴛᴏʀ ʙʏ Alif Ananta⸙', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
//payment                
      case 'dana':
             reply(`DANA : 085890617231`)
             break
                        
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/alifananta5`)
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/HbEeO3RlUosIYNX91xFhY2')
             break
//case menu
      case 'ownermenu':
  ...
  case 'allmenu':{
					if(MessageType == 'templateLocation'){
						var but = [
							...
							await Ramdani.sendMessage(from, lang.menunya(salam, pushname) , `© Alif Ananta`,pp_bot, but )
							}
